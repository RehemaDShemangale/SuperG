...
export default class Maskani extends Component {
  ...
  render(){
    return (
      ...
      <View 
        style={{
          flex:1,backgroundColor:'rgb(255, 255, 255)',
        ...
        >
           ...
           <View 
              ...
              >
                ...
                Namba ya simu kwa mawasiliano(Phone Number):</Text>
              <View 
                style={{
                  flexDirection:'row',
                  alignItems:'center'
              ...
              >Hivi punde tutakutumia namba(verification code) katika namba zako zote za simu kwa kukamilisha taarifa zako za awali. {'\n'}{'\n'} 
              </Text> 
              <Text 
                style={{
                  color:'rgba(255, 153, 0,10)',
